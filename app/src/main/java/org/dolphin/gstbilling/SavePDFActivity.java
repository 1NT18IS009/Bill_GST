...
import org.dolphin.gstbilling.R;

import org.dolphin.gstbilling.data.GSTBillingContract;
import org.dolphin.gstbilling.utils.NumberToWord;
import org.dolphin.gstbilling.utils.PDFUtils;
...
public class SavePDFActivity extends AppCompatActivity {
    ...
    private static void automaticSavePDF() {
        ...
        if(moreItemsPresent){
            ...
            pdfMaker.createPdf(thisActivity, billId + "_" + customerName);
            thisActivity.finish();
        }
    }
